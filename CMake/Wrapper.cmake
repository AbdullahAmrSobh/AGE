function(age_add_target)
    ...
    if(age_add_target_EXECUTABLE)
        ...
        add_executable(${age_add_target_NAME} ${SOURCE_FILES_LIST})
    ...
    elseif(age_add_target_SHARED)
        ...
        add_library(${age_add_target_NAME} SHARED ${SOURCE_FILES_LIST})
    elseif(age_add_target_MODULE)
        message("building a module")
        add_library(${age_add_target_NAME} MODULE ${SOURCE_FILES_LIST})
    else()
